...
pub fn прочитать_xlsx_с_диска(
    ...
    let mut workbook: Xlsx<_> = match open_workbook(путь) {
        ...
        Err(ошибка) => {
            ...
            return Ok(rapidhash::fast::RapidHashMap::with_hasher(rapidhash::fast::RandomState::default()));
...
fn вывод_страницы_словаря(
    ...
    let имя_страницы_для_вывода: String = match имя_страницы {
        ...
        Имена_страниц::составные => "Составные".to_string(),
        Имена_страниц::составные_важные => {
            "Составные_важные".to_string()
        }
        Имена_страниц::огласовки => "Огласовки".to_string(),
        Имена_страниц::вездесущие => "Вездесущие".to_string(),
