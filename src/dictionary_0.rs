            ...
            книга_взятая.вложения.par_iter_mut().enumerate()
                ...
                вывод_содержимого_строки_в_txt(
                    ...
                    //неизменное
                       ...
                       // &mut счётчик_неизменное_лок,
                        //"[0/4] Составные важные слова",
                        &format!("{} | [1/6] Неизменные слова",сообщение_текущее_вложение),
                        &книга_взятая.расширение,
                        &куча_пропусков,
                        &куча_словарь.неизменное,
                    );
                ...
                замена_слов_через_кучу(
                    ...
                    &format!("{} | [2/6] Составные важные слова",сообщение_текущее_вложение),
                    &книга_взятая.расширение,
                    &куча_пропусков,
                ...
                замена_слов_через_кучу(
                    ...
                    &format!("{} | [3/6] Вездесущие слова",сообщение_текущее_вложение),
                    &книга_взятая.расширение,
                    &куча_пропусков,
                ...
                замена_слов_через_кучу(
                    ...
                    //"[3/4] Составные  слова",
                    &format!("{} | [4/6] Составные  слова",сообщение_текущее_вложение),
                    &книга_взятая.расширение,
                    &куча_пропусков,
                ...
                замена_слов_через_кучу(
                    ...
                    //"[4/4] Простые слова",
                    &format!("{} | [5/6] Простые слова",сообщение_текущее_вложение),
                    &книга_взятая.расширение,
                    &куча_пропусков,
                    ...
                    замена_слов_через_кучу(
                        ...
                        //"[4/4] Простые слова",
                        &format!("{} | [6/6] Огласовки",сообщение_текущее_вложение),
                        &книга_взятая.расширение,
                        &куча_пропусков,
