...
pub fn вложижить_слова_замены_в_кучу_словарь(
    ...
    if имя_страницы == Text_Changer::Имена_страниц::Перевести {
...
pub fn счётчик_проходов_в_зависимости_от_разновидности_слова(
    ...
    return match имя_страницы {
        Имена_страниц::Простые => 3,
        Имена_страниц::Cоставные => 2,
        Имена_страниц::Составные_важные => 2,
...
fn определить_указатель_правописания_для_кучи(
    ...
    match имя_страницы {
        ...
        Имена_страниц::Простые => match указатель_уровня {
        ...
        Имена_страниц::Cоставные => match указатель_уровня {
            0 => Text_Changer::Правописание_слова::Все_строчные,
            1 => Text_Changer::Правописание_слова::С_Заглавной, // Изменен порядок
...
fn определить_указатель_искомого_раздела_для_кучи<'a>(
    ...
    match имя_страницы {
        Имена_страниц::Перевести => &mut уровень.перевести,
        Имена_страниц::Простые => &mut уровень.простое,
        Имена_страниц::Cоставные => &mut уровень.составное,
        Имена_страниц::Составные_важные => &mut уровень.составное_важное,
        Имена_страниц::Огласовки => &mut уровень.огласовки,
        Имена_страниц::Вездесущее => &mut уровень.вездесущее,
        Имена_страниц::Неизменные => &mut уровень.неизменное,
        Имена_страниц::Неизменные_короткие => {
        ...
        Имена_страниц::Запятые => &mut уровень.запятые,
    }
}
