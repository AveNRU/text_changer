...
pub async fn заменить_слова_в_книге_и_их_вывод(
    ...
    println!("шаг 2 - куча словарь готов");
    //начало замены слов
    ...
    println!("шаг 3 - словарь замен готов");
    //
    ...
    println!("шаг 4 - словарь разделителей готов");
    ...
    println!("шаг 8 - словарь_разделителей готов");
    //
    ...
    println!("шаг 9 - счётчики_разделителей готовы");
    // Создаем атомарные счетчики для каждого шаблона
    ...
    println!("шаг 10 - словарь_переносов готов");
    //
    ...
    println!("шаг 11 - счётчики_замен готов");
    let лупа = format!("🔍");
    //создание счётчиков
