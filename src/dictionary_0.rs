...
pub fn заменить_слова_в_книге(
    ...
    use crate::utils::regex::{
        замена_слов_через_regex, замена_слов_через_кучу, не_является_изображением, изображение_расширение_с_точкой
    };
        ...
        //остальные расширения
            ...
            let mut вложения_изначальные: Vec<lib::Вложения> = книга_взятая.вложения.clone();
             ...
             println!(
                 ...
                 style(&книга_взятая.название_книги).cyan(),
                 LOOKING_GLASS
             );
             //счётчик файлов всех
    ...
    *сообщения = временные_сообщения.into_inner().unwrap();
    ...
    fn проверка_есть_ли_изменения(содержимое_изначальное: &Vec<lib::Вложения>, 
        ...
        for k2 in 0..содержимое_изначальное.len() {
            if содержимое_изначальное[k2].содержимое == содержимое_изменённое[k2].содержимое {
                вывод_сообщения_на_экран_и_вложение_в_ряд(
                    format!("Книга: {}|[{}/{}]| Файл: {}  замены не были произведены", 
                            имя_книги, 
                        k2+1,
                ...
                вывод_сообщения_на_экран_и_вложение_в_ряд(
                    format!("Книга: {}|[{}/{}]| Файл: {}  были совершены замены", 
                            имя_книги,
                            k2+1,
                            содержимое_изначальное.len(),
                            содержимое_изначальное[k2].имя),
