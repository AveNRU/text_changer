...
pub fn заменить_слова_в_книге(
    ...
    книги.par_iter_mut().enumerate().for_each(|(указатель,книга_взятая)|{
   // for i in 0..ряд_исходных_книг.len() {
        ...
        if книга_взятая.расширение.contains("doc") {
           ...
           // for j in 0..временный_ряд_книг.len() {
            ...
            проверка_есть_ли_изменения(&вложения_изначальные,&книга_взятая.вложения,&книга_взятая.название_книги);
