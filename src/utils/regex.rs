...
pub fn добавить_разделители(
    ...
    содержимое
        ...
        .for_each(|(указатель_строки, строка)| {
            ...
            {
                /*let условие_у: bool = if ячейка.искомое_слово == "со" {
                    true
                } else {
                    false
                };
                ...
                if sz_найти(строка, &ячейка.искомое_слово) {
                    ...
                    if ячейка.re_образец_для_замены.is_match(&строка) {
                        ...
                        /*if sz_найти(&строка, "Иногда, правда,") {
                            условие_вывода = true
                        }*/
    ...
    let mut ряд_1: Словарь_разделителей = Словарь_разделителей {
        ряд_1: [
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["работ".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["изо".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["подор".to_string(), "подоб".to_string()],
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["дружест".to_string(), "дружес".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["бесед".to_string(), "беси".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["достойн".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                искомое_слово: "оплодо".to_string(),
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
