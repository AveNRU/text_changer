...
pub fn создать_словарь_разделителей() -> Result<Словарь_разделителей, String> {
    ...
    let mut итоговый_словарь: Словарь_разделителей = Словарь_разделителей {
        содержимое: vec![
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_пропусков: Vec::<String>::new().в_умные(),
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
                искомое_слово:
    ...
    //
    println!(
        "создать словарь разделителей - |{}| перед круговоротом ячейкой замены contains",
        счётчик_i,
    );
    счётчик_i += 1;
    //
    ...
    //
    println!(
        "создать словарь разделителей - |{}| перед круговоротом проверки повторов",
        счётчик_i,
    );
    счётчик_i += 1;
    //
    ...
    //
    println!(
        "создать словарь разделителей - |{}| перед круговоротом добавить_оставшиеся_поля",
        счётчик_i,
    );
    счётчик_i += 1;
    //
    ...
    //
    println!(
        "создать словарь разделителей - |{}| перед круговоротом образцы_поиска_re_для_проверки",
        счётчик_i,
    );
    счётчик_i += 1;
    //
