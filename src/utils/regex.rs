    ...
    let mut ряд_1: Словарь_разделителей = Словарь_разделителей {
        ряд_1: [
            Ячейка_замены_с_разделителями {
                ...
                замена: "мрако-".to_string(),
                re_образец_для_поиска: Regex::new(r"\b{start}мрако(\w){4,}").unwrap(),
                re_образец_для_замены: Regex::new(r"\b{start}(мрако)([\w]{4,})")
                    .unwrap(),
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
                искомое_слово: "казно".to_string(),
                замена: "казно-".to_string(),
                re_образец_для_поиска: Regex::new(r"\b{start}казно(\w){4,}").unwrap(),
                re_образец_для_замены: Regex::new(r"\b{start}(казно)([\w]{4,})")
                    .unwrap(),
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
                искомое_слово: "сбое".to_string(),
                замена: "сбое-".to_string(),
                re_образец_для_поиска: Regex::new(r"\b{start}сбое(\w){4,}").unwrap(),
                re_образец_для_замены: Regex::new(r"\b{start}(сбое)([\w]{4,})")
                    .unwrap(),
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                замена: "подор-".to_string(),
                re_образец_для_поиска: Regex::new(r"\b{start}подор(\w){4,}").unwrap(),
                re_образец_для_замены: Regex::new(r"\b{start}(подор)([\w]{4,})")
                    .unwrap(),
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                /*ряд_re_исключений:vec![Regex::new(r"\b{start}разно")
                                           .unwrap(),],*/
                //ряд_исключений:vec!["разбит".to_string()],
