...
use lib::{Словарь_Переносов, Ячейка_замены,Ячейка_замены_с_исключением,Счётчики_Словаря};
...
//если это картинка
use crate::lib::{self, Быстрый_Словарь, Полный_Словарь, Счётчик_замен, Ячейка_словаря};
...
pub fn re_получить_строку_с_описанием(
    ...
    let Some(строка) = образец.captures(&стог_сена) else {
        ...
        //        &образец, &стог_сена
        //    );
            return Err(format!( "Расширение файла: Ошибка при выдирания {}, сама строка : {}. Ошибка: {}",
    ...
    содержимое
        ...
        .for_each(|(указатель, строка)| {
            ...
            if sz_найти(&строка, &знак_переноса) {
                ...
                {
                    let re_исключение = &словарь_замен.исключения[указатель_образца].re_исключение;
                    let re_образец = &словарь_замен.исключения[указатель_образца].re_образец;
                    let искомое_слово = &словарь_замен.исключения[указатель_образца].искомое_слово;
                    ...
                    if sz_найти(&строка, искомое_слово) {
                        ...
                        if !re_исключение.is_match(&строка) {
                            ...
                            if bytesum(&замененная_строка) != bytesum(&строка) {
                                ...
                                //  println!("");
                                счётчики_замен.исключения[указатель_образца].fetch_add(1, Ordering::Relaxed);
    ...
    let словарь_замен: Словарь_Переносов = Словарь_Переносов {
        исключения:vec![
            Ячейка_замены_с_исключением{
                ...
                замена: "я".to_string(),
                re_образец: Regex::new(r"(?i)-я\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)\d-я\b{end}").unwrap(),
                         },
            Ячейка_замены_с_исключением{
                искомое_слово: "-го".to_string(),
                замена: "го".to_string(),
                re_образец: Regex::new(r"(?i)-го\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)\d-го\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением{
                искомое_слово: "-е".to_string(),
                замена: "е".to_string(),
                re_образец: Regex::new(r"(?i)-е\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)\d-е\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением{
                искомое_слово: "-ю".to_string(),
                замена: "ю".to_string(),
                re_образец: Regex::new(r"(?i)-ю\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)\d-ю\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением{
                искомое_слово: "-на".to_string(),
                замена: "на".to_string(),
                re_образец: Regex::new(r"(?i)-на\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)-на-").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-му".to_string(),
                замена: "му".to_string(),
                re_образец: Regex::new(r"(?i)-му\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)([\d,%])-му\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-ой".to_string(),
                замена: "ой".to_string(),
                re_образец: Regex::new(r"(?i)-ой\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)([\d%])-ой\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-ное".to_string(),
                замена: "ное".to_string(),
                re_образец: Regex::new(r"(?i)-ное\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)%-ное\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-ной".to_string(),
                замена: "ной".to_string(),
                re_образец: Regex::new(r"(?i)-ной\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)%-ной\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-ную".to_string(),
                замена: "ную".to_string(),
                re_образец: Regex::new(r"(?i)-ную\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)%-ную\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-line".to_string(),
                замена: "line".to_string(),
                re_образец: Regex::new(r"(?i)-line\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)empty-line\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-ментального".to_string(),
                замена: "ментального".to_string(),
                re_образец: Regex::new(r"(?i)-ментального\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)-ментального\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-ная".to_string(),
                замена: "ная".to_string(),
                re_образец: Regex::new(r"(?i)-ная\b{end}").unwrap(),
                re_исключение:Regex::new(r"(?i)%-ная\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
                искомое_слово: "-ную".to_string(),
                замена: "ную".to_string(),
        ...
        двубуквенные: vec![
            ...
            Ячейка_замены {
                ...
                замена: "ом".to_string(),
                re_образец: Regex::new(r"(?i)-ом\b{end}").unwrap(),
            },
            Ячейка_замены {
...
pub fn создать_счётчик_словаря_замен(словарь_замен:&Словарь_Переносов) -> Arc<Счётчик_замен> {
...
pub fn создать_второй_словарь_переносов(mut словарь_переносов:Словарь_Переносов) ->Словарь_Переносов {
    let замена_тире:Regex=Regex::new("-").unwrap();
    словарь_переносов.однобуквенные.par_iter_mut().enumerate().for_each(|(указатель,ячейка)|{
    ...
    словарь_переносов.многобуквенные.par_iter_mut().enumerate().for_each(|(указатель,ячейка)|{
          ячейка.искомое_слово=ячейка.искомое_слово.replace('-',"—");
        let новый_образец = ячейка.re_образец.as_str().replace("-", "—");
        ячейка.re_образец=Regex::new(&новый_образец).unwrap();
        ячейка.замена=ячейка.замена.replace('-',"—");
    });
    словарь_переносов.исключения.par_iter_mut().enumerate().for_each(|(указатель,ячейка)|{
          ячейка.искомое_слово=ячейка.искомое_слово.replace('-',"—");
        let новый_образец = ячейка.re_образец.as_str().replace("-", "—");
        ячейка.re_образец=Regex::new(&новый_образец).unwrap();
        ячейка.замена=ячейка.замена.replace('-',"—");
        ячейка.re_исключение=Regex::new(&ячейка.re_исключение.replace("-","—")).unwrap();
    });
    словарь_переносов.двубуквенные.par_iter_mut().enumerate().for_each(|(указатель,ячейка)|{
          ячейка.искомое_слово=ячейка.искомое_слово.replace('-',"—");
        let новый_образец = ячейка.re_образец.as_str().replace("-", "—");
        ячейка.re_образец=Regex::new(&новый_образец).unwrap();
        ячейка.замена=ячейка.замена.replace('-',"—");
    });
    словарь_переносов.трехбуквенные.par_iter_mut().enumerate().for_each(|(указатель,ячейка)|{
          ячейка.искомое_слово=ячейка.искомое_слово.replace('-',"—");
        let новый_образец = ячейка.re_образец.as_str().replace("-", "—");
        ячейка.re_образец=Regex::new(&новый_образец).unwrap();
        ячейка.замена=ячейка.замена.replace('-',"—");
    });
    словарь_переносов.целиковые.par_iter_mut().enumerate().for_each(|(указатель,ячейка)|{
          ячейка.искомое_слово=ячейка.искомое_слово.replace('-',"—");
        let новый_образец = ячейка.re_образец.as_str().replace("-", "—");
        ячейка.re_образец=Regex::new(&новый_образец).unwrap();
        ячейка.замена=ячейка.замена.replace('-',"—");
...
pub fn создать_третий_словарь_переносов(mut словарь_переносов:Словарь_Переносов) ->Словарь_Переносов {
    let замена_тире:Regex=Regex::new("-").unwrap();
    ...
    словарь_переносов.исключения.par_iter_mut().enumerate().for_each(|(указатель,ячейка)|{
        ...
        ячейка.re_образец=Regex::new(&новый_образец).unwrap();
        ячейка.замена=ячейка.замена.replace('-',&на_что_заменять);
        ячейка.re_исключение=Regex::new(&ячейка.re_исключение.replace("-",&на_что_заменять)).unwrap();
    });
    словарь_переносов.двубуквенные.par_iter_mut().enumerate().for_each(|(указатель,ячейка)|{
        ячейка.искомое_слово=ячейка.искомое_слово.replace('-',&на_что_заменять);
        let новый_образец = ячейка.re_образец.as_str().replace("-", &на_что_заменять);
...
pub fn создать_счётчики_словаря(полный_словарь: &Полный_Словарь) -> Arc<Счётчики_Словаря>{
