...
use lib::{Словарь_Переносов, Ячейка_замены,Ячейка_замены_с_исключением};
    ...
    let словарь_замен: Словарь_Переносов = Словарь_Переносов {
        исключения:vec![
            ...
            Ячейка_замены_с_исключением {
                ...
                re_исключение:Regex::new(r"(?i)%-ой\b{end}").unwrap(),
            },
            Ячейка_замены_с_исключением {
            ...
            Ячейка_замены_с_исключением {
                ...
                re_исключение:Regex::new(r"(?i)астрально-ментального\b{end}").unwrap(),
            },
        ],
        однобуквенные: vec![
            Ячейка_замены {
