    ...
    let mut ряд_1: Словарь_разделителей = Словарь_разделителей {
        ряд_1: [
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["обществ".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["нефт".to_string(), "нейро".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["половин".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["растущ".to_string(), "расте".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["высок".to_string(), "высш".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["разно".to_string(), "разыгр".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["последств".to_string(), "последн".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
