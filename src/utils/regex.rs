...
pub fn добавить_разделители(
    ...
    содержимое
        ...
        .for_each(|(указатель_строки, строка)| {
            ...
            {
                /*let условие_у: bool = if ячейка.искомое_слово == "у" {
                    true
                } else {
                    false
                };
                ...
                if sz_найти(строка, &ячейка.искомое_слово) {
                    ...
                    if ячейка.re_образец_для_замены.is_match(&строка) {
                        ...
                        /*if sz_найти(&строка, "влияет хмельной яд") {
                            условие_вывода = true
                        }*/
                        //
                            ...
                            количество_совпадений_успех <= количество_совпадений
                        {
                            ...
                            if let Some(найденное_совпадение) = ячейка
                                .re_образец_для_замены
                                .captures(&все_совпадения[начальный_указатель].as_str())
                            {
                                //
                                let уровень_букв= все_ли_заглавные_буквы_в_слове(
                                ...
                                let начало: usize =
                                    все_совпадения[начальный_указатель].start();
                                let конец: usize =
                                    все_совпадения[начальный_указатель].end();
                                ...
                                if замененная_строка != *строка {
                                    ...
                                    /*if условие_вывода && условие_у {
                                        ...
                                        println!("Все совпадения: |{:?}|", все_совпадения);
                                        println!("замена |{}|", замена);
                                        println!("начальный_указатель |{}|", начальный_указатель);
    ...
    let mut ряд_1: Словарь_разделителей = Словарь_разделителей {
        ряд_1: [
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["зарплат".to_string(), "забот".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["передне".to_string(), "передни".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["дружест".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
                искомое_слово: "вос".to_string(),
                ряд_исключений: vec!["востр".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["светло".to_string(), "свето".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["бесед".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["остров".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
