...
pub fn добавить_разделители(
    ...
    содержимое.par_iter_mut().enumerate().for_each(|(указатель_строки, строка)| {
        ...
        for (указатель_ячейки, ячейка) in словарь_разделителей.ряд_1.iter().enumerate() {
            ...
            if строка.contains(&ячейка.искомое_слово) {
                // Если есть совпадение с основным regex
                if ячейка.re_образец_для_поиска.is_match(строка) {
                    // Проверяем, не попадает ли строка под исключения
                    let есть_исключение:bool = ячейка.re_исключение.iter().any(|re| re.is_match(строка));
                    if !есть_исключение {
                        // Выполняем замену
                        let замененная_строка = ячейка.re_образец_для_замены.replace_all(строка, &ячейка.замена);
    ...
    let ряд_1: Словарь_разделителей = Словарь_разделителей {
        ряд_1:[
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}взрыво").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}мало").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}без").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}бес").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}долго").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}умо").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}сверх").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}воздухо").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}соот").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}бое").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены:Regex::new(r"\b{start}взаимо").unwrap(),
            },
        Ячейка_замены_с_разделителями {
        ...
        re_образец_для_поиска: Regex::new(r"\b{start}само(\w){4,}").unwrap(),
            re_исключение:vec![],
            re_образец_для_замены:Regex::new(r"\b{start}само").unwrap(),
    },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}хитро").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}противо").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}пожаро").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}самолето").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}самолёто").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}тазо").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}прапра").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                искомое_слово: "миров".to_string(),
                замена: "миров-".to_string(),
                re_образец_для_поиска: Regex::new(r"\b{start}миров(\w){4,}").unwrap(),
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}миров").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}пере").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}народо").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}верхо").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}старо").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}много").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}выше").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}разно").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}высоко").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}родо").unwrap(),
            },
            Ячейка_замены_с_разделителями {
                ...
                re_исключение:vec![],
                re_образец_для_замены: Regex::new(r"\b{start}узко").unwrap(),
            },
...
pub fn создать_второй_словарь_разделителей(mut словарь_изначальный:Словарь_разделителей) ->Словарь_разделителей {
    словарь_изначальный.ряд_1.par_iter_mut()
        ...
        .for_each(|(указатель, ячейка)| {
            ...
            let новый_образец:String = format!(r#"(?i)\b{{start}}{}\w"#,ячейка.искомое_слово);
            ячейка.re_образец_для_поиска = Regex::new(&новый_образец).unwrap();
            ячейка.замена = ячейка.замена.to_case(Case::Sentence);
        });
