    ...
    let mut ряд_1: Словарь_разделителей = Словарь_разделителей {
        ряд_1: [
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["надежд".to_string(), "надпис".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["получит".to_string(), "получен".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["растущ".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["предат".to_string(), "предел".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
            ...
            Ячейка_замены_с_разделителями {
                ...
                ряд_исключений: vec!["противо".to_string()],
                ..Default::default()
            },
            Ячейка_замены_с_разделителями {
