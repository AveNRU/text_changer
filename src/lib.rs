...
impl Основной_Вид_Расширения {
    ...
    pub fn не_архивная(&self) -> bool {
        self.fb2_mht() || self.md_yml_fs() || self.htm_html_xhtml_ncx()
    }
    //
...
pub static СЛОВАРЬ_ПЕРЕНОСОВ_МНОГОБУКВЕННЫЕ: usize = 60;
pub static СЛОВАРЬ_ПЕРЕНОСОВ_ЦЕЛИКОВЫЕ: usize = 251;
