                ...
                cx.open_window(
                    WindowOptions {
                        ...
                        window_bounds: Some(WindowBounds::Windowed(Bounds {
                            origin: gpui::point(px(100.0), px(100.0)), // Позиция на экране
                            size: size(px(800.0), px(600.0)),          // РАЗМЕР ОКНА
                        })),
                        ..Default::default()
                    },
                    |окно, cx| {
...
fn main2(
    ...
    //если включен перевод

    //если не нужен перевод книг - тогда сравниваем два словаря
