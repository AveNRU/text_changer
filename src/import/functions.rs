...
pub fn два_слова_из_одного_для_словаря(
    ...
    if если_слово_начинается_с_особых_знаков(&иходное_слово)
    {
        ...
        return Text_Changer::Два_Слова {
            все_строчные: обратно_убрать_особые_знаки(
                временный_составной_ряд.слово.to_case(Case::Lower),
            ),
            с_заглавной: обратно_убрать_особые_знаки(
...
pub fn три_слова_из_одного_для_словаря(
    ...
    if если_слово_начинается_с_особых_знаков(&иходное_слово)
    {
        ...
        return Text_Changer::Три_Слова {
            ...
            все_заглавные: обратно_убрать_особые_знаки(
                преобразовать_слово_с_чертой_в_начале(
...
pub fn если_слово_начинается_с_особых_знаков(
    ...
    let временный_составной_ряд: Text_Changer::Слово_и_знаки =
        найти_особые_знаки(&иходное_слово);
    //если слово начинается с  тире или нижнего подчёркивания: - _ или кавычки «
    if временный_составной_ряд.слово.starts_with('∵')
        || временный_составной_ряд.слово.starts_with('∴')
        || временный_составной_ряд.слово.starts_with('∷')
    {
        true
    } else {
