...
pub fn два_слова_из_одного_для_словаря(
    ...
    if если_слово_начинается_с_особых_знаков(&иходное_слово)
    {
        ...
        return (
            ...
            обратно_убрать_особые_знаки(преобразовать_слово_с_тире(временный_составной_ряд.0.to_case(Case::Sentence))),
            )
    }
    //если кавычки
    return (
...
pub fn три_слова_из_одного_для_словаря(
    ...
    if если_слово_начинается_с_особых_знаков(&иходное_слово)
    {
        ...
        return (
            обратно_убрать_особые_знаки(временный_составной_ряд.0.to_case(Case::Lower)),
            обратно_убрать_особые_знаки(преобразовать_слово_с_тире(временный_составной_ряд.0.to_case(Case::Sentence))),
            обратно_убрать_особые_знаки(преобразовать_слово_с_тире(временный_составной_ряд.0.to_case(Case::Upper))),
        )
    }
    //если кавычки
    return (
